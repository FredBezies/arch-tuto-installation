...
```
yaourt -S mate mate-extra lightdm-gtk-greeter gnome-icon-theme smplayer quodlibet python2-pyinotify accountsservice claws-mail system-config-printer ffmpegthumbailer pulseaudio pulseaudio-alsa libcanberra-{pulse,gstreamer} gtk3-print-backends **→** **(pour installer le support des imprimantes)**
```
